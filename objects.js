...
console.log("Hoi! Ik ben " + personalData.forName + ", ik ben " + personalData.age + " jaar oud.");
...
const tldr = ("De " + product.productName + " is gemaakt van " + product.material[0] + " en " + product.material[1]);
console.log(tldr);
